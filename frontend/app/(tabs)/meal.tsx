...
const API_URL = 'https://api.chavnapantry.com';
...
const MealScreen = () => {
 ...
 const confirmDelete = async () => {
   ...
   try {
     ...
     // no delete-meal endpoint in backend yet, need to implement in order for this to work
 ...
 return (
   <SafeAreaView style={styles.container}>
     ...
     {filteredMeals.length === 0 ? (
       ...
       <FlatList
         // data source
         data={filteredMeals} // Not sure why this was data = {data} but put it to meals as a fix for now since the page wasn't loading - Brandon
